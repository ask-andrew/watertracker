...
interface WateringCanIconProps {
  className?: string;
  fillColor?: string; // New prop to control fill color directly
}

const WateringCanIcon: React.FC<WateringCanIconProps> = ({ className, fillColor }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    viewBox="0 0 45.672 45.673" 
    fill={fillColor || "currentColor"} // Use fillColor for filled icons
    className={`w-6 h-6 ${className}`} // Default size, can be overridden by className
  >
    <g>
	    <g>
